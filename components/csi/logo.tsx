  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      ...
      >
        ...
        <line x1="24" y1="17" x2="24" y2="31" stroke="currentColor" strokeWidth="1.5" />
        <line x1="17" y1="24" x2="31" y2="24" stroke="currentColor" strokeWidth="1.5" />
        <line x1="17" y1="17" x2="31" y2="31" stroke="currentColor" strokeWidth="1" strokeOpacity="0.6" />
        <line x1="31" y1="17" x2="17" y2="31" stroke="currentColor" strokeWidth="1" strokeOpacity="0.6" />
      ...
      {showWordmark && (
        <div className={cn("font-semibold tracking-tight", text)}>
          ...
          <span className="text-muted-foreground font-normal ml-1">Smart Tech</span>
        </div>
      )}
    </div>
  )
