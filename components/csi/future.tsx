...
export function Future() {
  ...
  return (
    ...
    >
      ...
      {/* Glow effect */}
      <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-primary/10 rounded-full blur-3xl pointer-events-none" />
